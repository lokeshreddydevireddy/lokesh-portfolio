            ...
            <div className="flex flex-col">
              <div>
                ...
                <BlurIn delay={1.2}>
                  ...
                  >
                    Cloud Engineering Intern <br />
                    AWS • Linux • DevOps • Full Stack Development
                  </p>
                </BlurIn>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-3 w-fit">
                <Link
                  href={
                    "https://drive.google.com/file/d/1ZM3PDgAzjbZECnCcZIcIODBL2DHxVt2q/view?usp=drive_link"
                  }
                  target="_blank"
                  className="flex-1"
                >
                ...
                {/* Professional Sub-text added below Resume */}
                <p className="text-sm text-zinc-500 mt-1 cursor-default">
                  Final Year IT Student at DIET • Cloud Engineering Intern @ Edubot
                </p>
