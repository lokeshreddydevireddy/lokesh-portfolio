...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Working with AWS services including EC2, S3, IAM, VPC, CloudWatch and SNS.",
      "Configured IAM users, groups, policies and MFA for secure cloud access.",
      "Performed Linux administration and server management tasks.",
      "Used Git and GitHub for version control and project collaboration.",
      "Deployed and managed cloud-based applications and infrastructure.",
      "Gained hands-on experience with networking, security groups and cloud architecture."
    ],
    skills: [
      SkillNames.AWS,
      SkillNames.LINUX,
